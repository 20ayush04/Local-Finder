...
<body class="min-h-screen flex flex-col md:flex-row">
    ...
    <script>
        ...
        const parseChartData = (dataString, defaultData, maxLength) => {
            ...
            try {
                const parsed = dataString.split(',')
                    ...
                    .slice(0, maxLength); // Cap the length
        ...
        // Dynamic label generation with max length
        ...
        const maxDailyLength = 30; // Cap at 30 days
        ...
        const maxYearlyLength = 10; // Cap at 10 years
        ...
        // Debug output
        console.log('Daily Sales Raw:', dailySalesRaw);
        console.log('Daily Sales Values:', dailySalesValues);
        console.log('Daily Sales Labels:', dailySalesLabels);
        console.log('Yearly Sales Raw:', yearlySalesRaw);
        console.log('Yearly Sales Values:', yearlySalesValues);
        console.log('Yearly Sales Labels:', yearlySalesLabels);
    </script>
</body>
</html>